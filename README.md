...
git clone https://github.com/Crapcraft/FMHY-Notify.git
cd FMHY-Notify
npm install
...
To get a webhook URL: in your Discord server, right-click the channel → **Edit Channel** → **Integrations** → **Webhooks** → **New Webhook**, then copy the URL.
